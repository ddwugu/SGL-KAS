...
# Main Streamlit app
def main():
    st.title('Pertamina Field Jambi SGL-KAS')
    st.subheader('Prediksi Lokasi Kebocoran Line SGL-KAS Regresi Model')

    Titik_1_PSI = st.text_input('Input delta pressure drop di GS 02 sgl(PSI)')
